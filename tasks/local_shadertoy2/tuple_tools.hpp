...
auto to_tuple(T&& object) noexcept
{
  ...
  if constexpr (is_braces_constructible<Type, AnyType, AnyType, AnyType, AnyType, AnyType, AnyType>)
  {
    auto&& [p1, p2, p3, p4, p5, p6] = object;
    return std::make_tuple(p1, p2, p3, p4, p5, p6);
  }
  else if constexpr (is_braces_constructible<Type, AnyType, AnyType, AnyType, AnyType, AnyType>)
  {
